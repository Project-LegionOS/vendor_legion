...
LEGION_BUILD_TIME := $(shell date +%H%M)
...
# MAIN
LEGION_VERSION := LegionOS-$(LEGIONVERSION)-$(LEGION_BUILD)-$(LEGION_BUILD_DATE)-$(LEGION_BUILD_TIME)-$(LEGION_BUILD_TYPE)-$(LEGION_BUILD_ZIP_TYPE)
